...
import com.lsz.wd_lsz.callback.CallcarBack;
import com.lsz.wd_lsz.entiey.gouche_entity.ShoppingCatr;
...
public class My_adapter2 extends XRecyclerView.Adapter<My_adapter2.Iv_v>{
    ...
    private List<ShoppingCatr.Cart.Product> list;
    ...
    public My_adapter2(List<ShoppingCatr.Cart.Product> list, Context context) {
        this.list = list;
    ...
    public void onBindViewHolder(@NonNull final Iv_v iv_v, int i) {
        final ShoppingCatr.Cart.Product cart = list.get(i);
        ...
        iv_v.checkBox.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (!iv_v.checkBox.isChecked()){
                    ...
                    for (ShoppingCatr.Cart.Product p: list) {
