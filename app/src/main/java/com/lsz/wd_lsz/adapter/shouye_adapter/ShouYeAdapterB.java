...
public class ShouYeAdapterB extends XRecyclerView.Adapter<ShouYeAdapterB.ViewHolder1> {

    private  Context context;

    private List<Shouye.ResultBean.Bean.CommodityListBean> list;

    public ShouYeAdapterB(Context context, List<Shouye.ResultBean.Bean.CommodityListBean> list) {
    ...
    public ViewHolder1 onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        View view = LayoutInflater.from(context).inflate(R.layout.shouye_b,viewGroup,false);
    ...
    public class ViewHolder1 extends RecyclerView.ViewHolder {
        ...
        public ViewHolder1(@NonNull View itemView) {
            ...
            imageView = itemView.findViewById(R.id.image_b_i);
            jia = itemView.findViewById(R.id.text_b_jia);
            name = itemView.findViewById(R.id.text_b_name);
        }
    }
}
