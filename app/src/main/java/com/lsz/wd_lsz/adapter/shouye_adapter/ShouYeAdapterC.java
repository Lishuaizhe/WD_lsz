...
public class ShouYeAdapterC extends XRecyclerView.Adapter<ShouYeAdapterC.ViewHolder1> {

    private  Context context;

    private List<Shouye.ResultBean.Bean.CommodityListBean> list;

    public ShouYeAdapterC(Context context, List<Shouye.ResultBean.Bean.CommodityListBean> list) {
