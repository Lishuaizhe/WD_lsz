...
public class Shouye {
    ...
    public static class ResultBean {
        private List<Bean> rxxp;
        private List<Bean> pzsh;
        private List<Bean> mlss;


        public List<Bean> getRxxp() {
            return rxxp;
        }

        public void setRxxp(List<Bean> rxxp) {
            this.rxxp = rxxp;
        }

        public List<Bean> getPzsh() {
            return pzsh;
        }

        public void setPzsh(List<Bean> pzsh) {
            this.pzsh = pzsh;
        }
